      ...
      <main className="flex-1 overflow-y-auto min-w-0">
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-8 py-4 md:py-6">
          ...
          {!loading && completedTasks.length > 0 && (
           ...
           <footer className="hidden md:flex fixed bottom-0 right-0 px-6 py-3 flex items-center gap-4 text-[10px] text-gray-300 z-10">
        <span>{"© " + new Date().getFullYear() + " RealTasks"}</span>
        <span>{"—"}</span>
        <a href={"mailto:adidevjj@gmail.com"} className="hover:text-gray-500 transition-colors">
          {"adidevjj@gmail.com"}
        </a>
        <a href={"https://github.com/adikyochan/realtime-collab-task-manager"} target="_blank" rel="noopener noreferrer" className="hover:text-gray-500 transition-colors flex items-center gap-1">
